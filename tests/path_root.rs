...
async fn invalid_path_root() {
    ...
    match files::list_folder(&client, ListFolderArg::new("/".to_owned())).await {
        ...
        // giving a bogus nsid.
        Err(dropbox_sdk::Error::UnexpectedHttpError { code: 422, response_body: json, .. }) => {
