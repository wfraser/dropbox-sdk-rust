...
//! [`Metadata`](crate::files::Metadata) of a file, which can be used to verify the integrity of an
//! upload or download.
...
use crate::file_helpers::BLOCK_SIZE;
...
impl ContentHash {
    ...
    fn finish_block(&mut self) {
        let block_hash = std::mem::replace(&mut self.block_ctx, HashContext::new(&SHA256))
            .finish();
